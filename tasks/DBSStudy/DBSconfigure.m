...
primaryUI = topNode.nodeData{'Settings'}{'uiList'};
if iscell(primaryUI)
   primaryUI = primaryUI{1};
end
strind = find(strncmp(primaryUI, strs(:,1), length(primaryUI)) | strcmp('default', strs(:,1)), 1);
