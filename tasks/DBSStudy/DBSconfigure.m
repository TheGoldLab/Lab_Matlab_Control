...
welcome = {@showText, topNode.helpers.feedback, strs(index, 2:3), [], ...
...
countdown = {@showMultipleMessages, topNode.helpers.feedback, ...
   'text',     callStrings, ...
   'image',   {'fileNames', {'greatJob.jpg'}, 'y', 4, 'height', 13}, ...
