...
switch location
   ...
   case {'debug' 'Debug'}
      arglist = { ...
         'taskSpecs',            {'Quest' 4 'SN' 1 'AN' 1}, ...%{'Quest' 50 'SN' 50 'AN' 50}, ...
...%         'taskSpecs',            {'VGS' 1 'MGS' 1 'Quest' 4 'SN' 1 'AN' 1}, ...%{'Quest' 50 'SN' 50 'AN' 50}, ...
         'sendTTLs',             false, ...
         'uiList',               'dotsReadableHIDKeyboard', ... %'dotsReadableEyeEyelink', ...%'dotsReadableEyePupilLabs', ... %'dotsReadableHIDKeyboard', ... % or 'dotsReadableEyeMouseSimulator'
