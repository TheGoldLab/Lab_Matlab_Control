...
...%         'taskSpecs',            {'VGS' 1 'MGS' 1 'Quest' 4 'SN' 1 'AN' 1}, ...%{'Quest' 50 'SN' 50 'AN' 50}, ...
         'taskSpecs',            {'Quest' 1}, ... % 'SN' 1 'AN' 1}, ...%{'Quest' 50 'SN' 50 'AN' 50}, ...
         'sendTTLs',             false, ...
         'uiList',               'dotsReadableHIDButtons', ... %'dotsReadableEyeEyelink', ...%'dotsReadableEyePupilLabs', ... %'dotsReadableHIDKeyboard', ... % or 'dotsReadableEyeMouseSimulator' ... 'dotsReadableHIDButtons'
