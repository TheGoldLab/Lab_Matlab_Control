classdef topsTreeNodeTaskSaccade < topsTreeNodeTask
   ...
   properties % (SetObservable) % uncomment if adding listeners
      ...
      trialDataFields = {'RT', 'choice', 'correct', 'fixationOn', 'fixationStart', ...
         'targetOn', 'targetOff', 'fixationOff', 'feedbackOn'};
   ...
   methods
      ...
      function setChoice(self, eventTag)
         ...
         self.setTrialData([], 'RT', trial.(eventTag) - trial.fixationOff);
      ...
      function showFeedback(self)
         ...
         if trial.correct == 1
            feedbackArgs = {'Correct!', ...
               self.settings.correctImageIndex, self.settings.correctPlayableIndex};
         else
            feedbackArgs = {'No choice, try again!', ...
               self.settings.errorImageIndex, self.settings.errorPlayableIndex};
         end
         ...
         self.statusStrings{2} = sprintf('Trial %d/%d, dir=%d: %s, RT=%.2f', ...
            ...
            trial.direction, feedbackArgs{1}, trial.RT);
   ...
   methods (Access = protected)
      ...
      function initializeStateMachine(self)
         ...
         chkuic = {@readEvent, self.helpers.reader, {'choseTarget'}, self, 'choice'};                  
         setchc = {@setChoice, self, 'choice'};                  
