...
if ~usingRemote
    ...
    ensembleFunction = @(X)dotsClientEnsemble(X, ...
       state{'Remote'}{'clientIP'}, ...
       state{'Remote'}{'clientPort'}, ...
       state{'Remote'}{'serverIP'}, ...
       state{'Remote'}{'serverPort'});
end
...
% get direction and coherence from the current trial
