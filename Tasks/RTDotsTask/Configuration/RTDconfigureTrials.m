...
trials = struct( ...
   ...
   'time_eye_trialStart', nan, ...
   'time_screen_trialStart', nan, ...
   'time_TTLBlock', nan, ...
   'time_TTLTrial', nan, ...
   'time_local_insOn', nan, ...
   'time_screen_insOn', nan, ...
   'time_local_fixOn', nan, ...
   'time_screen_fixOn', nan, ...
   'time_local_targsOn', nan, ...
   'time_screen_targsOn', nan, ...
   'time_local_dotsOn', nan, ...
   'time_screen_dotsOn', nan, ...
   'time_local_dotsOff', nan, ...
   'time_screen_dotsOff', nan, ...
   'time_local_fdbkOn', nan, ...
   'time_screen_fdbkOn', nan, ...
   'time_local_trialFinish', nan, ...
   'time_eye_trialFinish', nan, ...
