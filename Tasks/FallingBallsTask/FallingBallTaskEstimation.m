...
list{'timing'}{'animation time'}= 1.1;
list{'timing'}{'rest time'}     = .5;
...
question.string = 'Where is the Red Ball?';
...
tAni    = list{'timing'}{'animation time'};
...
%question appear above.
fixedStates = { ...
    'name'      'entry'    'input' 'timeout' 'exit'  'next'; ...
    'Begin'     {}           {}          0       {}      'set'; ...
    'set'       {@Set_cue, list} {}       tSet        {}   'animate';...   
    'animate'   {@startAnimation, list}      {}       tAni      {}      'rest'; ...
    'rest'      {@rest, list} {}         tRest       {}    'prepare';...
    'prepare'   {}   {@test, list}       0       {}      'finish'; ...
    'ballclear' {@ballclear, list} {}    0       {}   'Pposition';...
    'Pposition' {on quest}    {}     0       {}     'position';...
    'position'  {}           Fpos    tChoice       {}     'finish'; ...
...
%     Always show the ceiling during observation trials
    ...
    drawables.setObjectProperty('isVisible',false,[mask_index mask2_index question]);
...
stim_counter = list{'timing'}{'counter'};
if stim_counter <= logic.observation
    drawables.setObjectProperty('isVisible', true, [set_index fall_ball_samp_cue]);
    drawables.setObjectProperty('isVisible', false, fall_ball_mean_cue);
else
    drawables.setObjectProperty('isVisible', true, [set_index fall_ball_samp_cue]);
    drawables.setObjectProperty('isVisible', false, fall_ball_mean_cue);
end
...
drawables.setObjectProperty('isVisible', false, [fall_ball_mean_cue fall_ball_samp_cue set_index]);
...
% ++++++++
% FUNCTION: ballclear
% clears the balls out before the user can begin to move the target
function ballclear(list)
% hide the balls
drawables = list{'graphics'}{'drawables'};
...
% Get the difference between where the user thought the redball would be
