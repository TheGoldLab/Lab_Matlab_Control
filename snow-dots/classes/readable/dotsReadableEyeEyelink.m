classdef dotsReadableEyeEyelink < dotsReadableEye
   ...
   methods (Access = protected)
      ...
      function status = calibrateDevice(self, varargin)
         ...
         % Start with failure in case we need to abort
         status = 0;
         ...
         % Check for calibration/drift correction
         if nargin < 2
            ...
            while continueCalibration
               ...
               if bitand(currentMode, self.IN_SETUP_MODE) && ...
                  ...
                  elseif (targetCheck==1 && targetX ~= self.MISSING && ...
                     ...
                     calibrationEnsemble.setObjectProperty('xCenter', targetX);
                     calibrationEnsemble.setObjectProperty('yCenter', targetY);
            ...
            if Eyelink('CalResult')==1
               play(self.calibrationPlayables{1}); % Success!!
            else
               play(self.calibrationPlayables{2}); % Failure!!
            end
            ...
            % args are:
            %  2. flag indicating drift correction
            %  3. [x,y] position of target
            %  4. flag to draw the target or not
            ...
            if drawTarget
               ...
               % Present calibration target at the updated position
               calibrationEnsemble.setObjectProperty('xCenter', xy(1));
               calibrationEnsemble.setObjectProperty('yCenter', xy(2));
