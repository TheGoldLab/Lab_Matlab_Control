...
%
%  DATA = COMM( 'readEP', PORT, N) reads eye positions from the ASL serial port.
%	 DATA is a 4 by n uint8 matrix. Each column contains eye position output from
%	 ASL at one time instance, which contains:
%		[status; pupil diameter; horizontal eye position; vertical eye position]
%	 If no data is avilable, DATA is empty.
%
% $Id: comm.m,v 1.1.1.1 2004/05/18 15:02:25 tom Exp $
% Modified by jcl on 19-Feb-05 
