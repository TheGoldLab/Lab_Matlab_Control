function states_ = gXsimpleDemo_statelist(varargin)
...
% dXdots object #1.  If the value is 180, then "left" was the correct
% choice and we should jump to thestate called "correct".  If the value was
% 0 then "left" was incorrect so jump to the state called "incorrect".
left_cond = ...
    {'jump', {'dXdots', 1, 'direction'}, [180 0], {'correct'; 'incorrect'}};

% This one is similar, but checks whether "right" was the correct or
% incorrect choice.
right_cond = ...
    {'jump', {'dXdots', 1, 'direction'}, [180 0], {'incorrect'; 'correct'}};
...
% shothand for playing beeps and sounds
SP = @rPlay;
bp = 'dXbeep';
sd = 'dXsound';
...
arg_dXstate = {{ ...
    'clear',    {}, {},         'next', 0,      0,  5,  0,      {}; ...
    'fixOn',    GS, fix,        'next', 200,	0,  3,  0,      {}; ...
    'ready1',	SP, {bp,1},     'next', 100,	0,  0,  noTouch,{}; ...
    'newDots',	VU, {'dXtc'},	'next', 800,    0,  0,  1,      {}; ...
    'ready2',	SP, {bp,1},     'next', 100,    0,  0,  1,      {}; ...
    'dotsOn',	GS, dots,       'next', 1000,	0,  1,  1,      {}; ...
    'respond',  GS, noDots,     'error',1000,   0,  3,  respond,{}; ...
    'left',     {}, {},         'error',0,      0,  0,  0,      left_cond; ...
    'right',	{}, {},         'error',0,      0,  0,  0,      right_cond; ...
    'correct',  SP, {sd,1},     'next',	0,      0,  0,  0,      {}; ...
    'cText',    GS, {tx,1},     'end',  500,    0,  3,  0,      {}; ...
    'incorrect',SP, {sd,2},     'next',	0,      0,  0,  0,      {}; ...
    'iText',    GS, {tx,2},     'end',  500,    0,  3,  0,      {}; ...
    'error',    SP, {bp,2},     'next', 100,	4,  0,  0,      {}; ...
    'eText',    GS, {tx,3},     'end',  1000,   0,  3,  0,      {}; ...
    'end',      {}, {},         'x',    0,      0,  5,  0,      {}; ...
    }};
