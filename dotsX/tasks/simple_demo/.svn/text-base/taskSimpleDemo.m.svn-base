function index_ = taskSimpleDemo(varargin)
...
arg_dXtc = { ...
    'name',     {'dot_dir',                     'dot_coherence'}, ...
    'values',	{[180, 0],                      coherences}, ...
...
index_ = rAdd('dXtask', 1, dXtask_rAdd_args, ...
    ...
    'gXsimpleDemo_graphics',	1,  group_rAdd_args,    {}; ...
    'gXsimpleDemo_hardware',	1,  group_rAdd_args,    {mute}; ...
    'gXsimpleDemo_statelist',	1,  group_rAdd_args,    {}; ...
    }, ...
    'name',	taskName, ...
    'blockReps', numBlocks, ...
    'statesToFIRA', ...
