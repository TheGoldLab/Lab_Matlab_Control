function index_ = taskDiscrim3afcContrast(varargin)
%Task for 3afc Gaussian contrast discrimination, near accelerating PF shoulder
%   index_ = taskDiscrim3afcContrast(varargin)
%
%   no eyetracker
%   lpHID choices
%
