function index_ = taskDetectRDots(varargin)
%Dots task for rightward motion detection, near accelerating PF shoulder
%   index_ = taskDetectRDots(varargin)
%
%   no eyetracker
%   lpHID choices
%
...
arg_dXtc = { ...
    ...
    'values',       {[0 0 0 0 0 1.6 3.2 6.4 12.8 25.6], [0]}, ...
