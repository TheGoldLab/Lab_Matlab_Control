...
mute = false;
 taskList = {'taskSSD', 1, {10000, SSDs, mute},... %number of repititions here, also specifies relative proportions
             'taskVGS', 2, {10000, mute}};
% taskList = {'taskVGS', 1, {numTrials, mute}};
