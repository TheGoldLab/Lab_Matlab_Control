...
%%%set up to flag a lever pull that happens in between target_on and SSD_on
fixbetw = { ...
    'dXkbHID',  {'any', 'error'}; ...
    'dXPMDHID', {11, 'flagit', 9, 'flagit'}; ...
    'dXasl',    {[-8,-8,16,16,false,inf], 'error', true}};
%   'dXasl',    {[2,false,inf], 'error', true}};
...
SSD_inc = ...
    {'jump', {'dXtarget', 3, 'x'}, [-7 7], {'wait2'; 'wait2'}};
SSD_cor = ...    
...
GO = ...
    {'jump', {'dXtask', 1, 'userData'}, [1], {'respond'}};
...
%   'ready1',	SP, {bp,1},     'next', 1000,	0,  0,  noTouch,{}; ...
    ...
    'targetOn', GS, target,     'SSD_on', 0,      0,  3,  fixbetw, {}; ...
    'flagit',   FI, {},         'next', 0,      0,  0,  0,       {}; ...
    'SSD_on',   GS, fix,        'next', 0,      0,  3,  fixate, {}; ...
    ...
    'checkflag', {}, {},        'next', 0,      0,  0,  0,     GO; ...
    'respond',  {}, {},         'ssd',  3000,   0,  3,  respond,{}; ...
    'left',     {}, {},         'error',0,      0,  0,  0,      SSD_inc; ...
    'right',	{}, {},         'error',0,      0,  0,  0,      SSD_inc; ...
    'ssd',      {}, {},         'error',0,      0,  0,  fixate, SSD_cor; ...
    ... 
    'wait2',    {}, {},         'next',     1000,  0,  0, fixate1, {}; ...
