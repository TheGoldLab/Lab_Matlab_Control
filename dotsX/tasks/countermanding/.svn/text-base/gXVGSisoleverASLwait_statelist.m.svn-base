...
%     'dXPMDHID', {9, 'ASLLEFT', 11, 'ASLRIGHT'}; ...
    'dXkbHID',  {}; ...
    'dXPMDHID', {}; ...
    'dXasl',    {[-8,-8,16,16,true,inf], 'hold', true}};
...
%     'dXPMDHID', {9, 'ASLLEFT', 11, 'ASLRIGHT'}; ...
    'dXkbHID',  {}; ...
    'dXPMDHID', {}; ...
    'dXasl',    {[-8,-8,16,16,false,inf], 'acquire', true}};
...
fixate = { ...
    'dXkbHID',  {'any', 'error'}; ...
    'dXPMDHID', {'any', 'error'}; ...
    'dXasl',    {[-8,-8,16,16,false,inf], 'error', true}};
...
left_cond = ...
    {'jump', {'dXtarget', 3, 'x'}, [-7 7], {'wait1'; 'wait2'}};

% This one is similar, but checks whether "right" was the correct or
% incorrect choice.
right_cond = ...
    {'jump', {'dXtarget', 3, 'x'}, [-7 7], {'wait2'; 'wait1'}};
...
%   'newfix',   VU, {'dXtc'},	'next', 0,      0,  0,  1,      {}; ...
    ...
    ...  
    'confixing',{}, {},         'next', {'uniform', 1700, 2000},   0,  0,  fixate, {}; ...
    'fixOff',   GS, nofix,      'next', 0,      0,  3,  0,      {}; ...
    'newtarget',VU, {'dXtc'},	'next', 0,      0,  0,  1,      {}; ...
    'targetOn', GS, target,     'next', 0,      0,  3,  fixate, {}; ...
    ...
    'respond',  {}, {},         'error',600,    0,  3,  respond,{}; ...
    'left',     {}, {},         'error',0,      0,  0,  left,   left_cond; ...
    'right',	{}, {},         'error',0,      0,  0,  right,  right_cond; ...
    'both',     {}, {},          err,    0,      0,  0,  0,      {}; ...
    ...
    'wait1',    {}, {},         'wait3', 1000,     0, 0,  fixate1, {}; ... 
    'wait2',    {}, {},         'wait4', 1000,     0, 0,  fixate1, {}; ... 
    'wait3',     {}, {},        'correct', 2000,  0, 0,  fixate,  {}; ...
    'wait4',     {}, {},        'incorrect', 2000,0, 0,  fixate,  {}; ...
    'correct',  SP, {sd,1},     'clear',0,      0,  0,  0,        {}; ...
    'incorrect',SP, {sd,2},     'clear',0,      0,  0,  0,        {}; ...
    'error',    SP, bp,     'clear',100,	4,  0,  0,        {}; ...
    'clear',    GS, notarget,   'end',  0,      0,  3,  0,        {}; ...
    'end',      {}, {},         'x',    0,      0,  0,  0,        {}; ...
    }};
