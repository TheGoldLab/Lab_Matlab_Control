...
%     'dXPMDHID', {9, 'ASLLEFT', 11, 'ASLRIGHT'}; ...
    'dXkbHID',  {}; ...
    'dXPMDHID', {}; ...
    'dXasl',    {[-3,-4,6,8,true,inf], 'hold', true}};
...
%     'dXPMDHID', {9, 'ASLLEFT', 11, 'ASLRIGHT'}; ...
    'dXkbHID',  {}; ...
    'dXPMDHID', {}; ...
    'dXasl',    {[-3,-4,6,8,false,inf], 'acquire', true}};
...
fixate = { ...
    'dXkbHID',  {'any', 'error'}; ...
    'dXPMDHID', {'any', 'error'}; ...
    'dXasl',    {[-3,-4,6,8,false,inf], 'error', true}};
