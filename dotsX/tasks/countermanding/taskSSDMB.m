function index_ = taskSSDMB(varargin)
...
%%%BE CAREFUL with the numbered state you put in after 'dxstate' this
%%%should correspond to the state before 'newSSD' (i.e. 'targetOn')
arg_dXtc = { ...
    'name',     {'target_dir',               'SSD'}, ...
    'values',	{[-7, 7],                  SSDs}, ...
    'ptr',      {{'dXtarget', 2, 'x'},      {'dXstate', 6, 'wait'}}}; ...

% The number of trial conditions is the number of coherences times times
%   the number of directions
numConditions = 2*length(SSDs); 
...
index_ = rAdd('dXtask', 1, dXtask_rAdd_args, ...
    'helpers', ...
    { ...
    'dXtc',             2,  dXtc_rAdd_args,     arg_dXtc; ...
    'gXCMD_graphicsMB',	1,  true,    {}; ...
    'gXCMDnolevers_hardwareMB',	1,  true,    {mute}; ...
    'gXSSD_statelistMB',	1,  false,    {}; ...
    }, ...
    'name',	taskName, ...
    'blockReps', numBlocks, ...
    'statesToFIRA', ...
