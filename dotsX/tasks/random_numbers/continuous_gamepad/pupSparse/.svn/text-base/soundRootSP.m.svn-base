...
tL = { ...
    'taskRandom_soundSP', numBlocks, {blockSD, mSbs, half, fixSound} ...
    };
...
pName = ['random_soundSP_',subject];

% place to save data
FIRADir = ...
    ['/Users/lab/GoldLab/Data/random_numbers/soundSP/', subject];
if exist(FIRADir) ~=7
    mkdir(FIRADir)
end
...
ROOTDir = ['/Users/lab/GoldLab/Data/random_numbers/soundSP/', subject];
