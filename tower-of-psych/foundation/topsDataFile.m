classdef topsDataFile
   ...
   methods (Static)
      ...
      function [fHeader, incrementCell] = read(fHeader, increments)
         ...
         if exist(fHeader.fileWithPath, 'file')
            
            % jig removed 2/9/19 because who -file kept crashing
            ...
            s = load(fHeader.fileWithPath);
            contents = fieldnames(s);
      ...
      function fHeader = write(fHeader, newIncrement)
         ...
         if nargin > 1
            ...
            save(fHeader.fileWithPath, ...
               '-struct', 's', incrementName, '-append');
            %                 save(fHeader.fileWithPath, incrementName, ...
            %                     '-struct', 's', incrementName, '-append');
