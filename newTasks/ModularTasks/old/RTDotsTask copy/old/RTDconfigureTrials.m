function trials = RTDconfigureDotsTrials(directions, coherences, directionPriors, ...
   trialsPerCoherence)
% function trials_ = RTDconfigureDotsTrials(directions, coherences, directionPriors, ...
%   trialsPerCoherence)
%
