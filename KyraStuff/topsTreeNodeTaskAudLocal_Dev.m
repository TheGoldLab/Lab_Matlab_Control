classdef topsTreeNodeTaskAudLocal_Dev < topsTreeNodeTask
    ...
    properties % (SetObservable) % uncomment if adding listeners
        ...
        trialDataFields = {'RT', 'choice', 'correct', 'direction', 'location', ...
            'randSeedBase', 'fixationOn', 'fixationStart', 'breakFix', 'targetOn','refOn','refOff' ...
    ...
    methods
        ...
        %% Check for break
        function nextState=checkForBreak(self,events, eventTag)
    ...
    methods (Access = protected)
        ...
        function initializeStateMachine(self)
            ...
            chkuib  = {@checkForBreak, self,{'choseLeft' 'choseRight'}, 'breakFix'}; % {@getNextEvent, self.readables.theObject, false, {}}; % {'brokeFixation'}
            ...
            states = {...
                ...
                'showTargets'       showt    chkuib   t.preDots             gwts    'pause'         ; ...
                'preDots'           refOn    chkuib       .5               refOff      'pause'                ; ...
                'pause'            {}        chkuib      .5                  {}        '';...
                'playSoundRT'       soundOn  chkuic   t.dotsTimeout         muted   'blank'           ; ...
                'playSoundFX'        soundOn  chkuib       t.dotsDuration        muted   'waitForChoiceFX' ; ...
                'waitForChoiceFX'   {}       chkuic   t.choiceTimeout       {}      'blank'           ; ...
                'blank'             muted       {}       0.2                   blanks  'showFeedback'    ; ...
