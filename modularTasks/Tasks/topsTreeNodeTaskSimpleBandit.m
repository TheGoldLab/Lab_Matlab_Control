classdef topsTreeNodeTaskSimpleBandit < topsTreeNodeTask
   ...
   properties % (SetObservable) % uncomment if adding listeners
      ...
      settings = struct( ...
         ...
         'targetDistance',             8,    ...
         'textStrings',                'Choose the left or right card',   ...
         'correctImage',               'thumbsUp.jpg',      ... % see topsTaskHelperFeedback
         'errorImage',                 [],   ...
         'correctPlayable',            'cashRegister.wav', ...   
      ...
      % Feedback specs
      feedback = struct( ....
         'texts',       {'No choice', 'Good choice', 'Bad choice'}, ...
         'images',      {[], {'thumbsUp.jpg', {'height' 12}}, {'sorry.jpg', {'height' 12}}}, ...
         'sound',       {[], 'cashRegister.wav', 'buzzer.wav'}, ...
         'bgStart',     {[0 0 0.6], [0 0.6 0], [0.6 0 0]}, ...
         'bgEnd',       [0 0 0]);
   ...
   methods
      ...
      function showFeedback(self)
         ...
         % Check for good trial
         if ~self.completedTrial
            
            % No choice!
            feedbackStr = 'No choice';
            feedbackArgs = { ...
               'backgroundStartColor', [0 0 0.6], ...
