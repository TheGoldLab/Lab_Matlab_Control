classdef topsTreeNodeTaskReversingDotsDebug < topsTreeNodeTask
    ...
    properties % (SetObservable)
        ...
        drawable = struct( ...
            ...
            'dots',                       struct( ...
            'fevalable',                  @dotsDrawableDotKinetogramDebug, ...
            'settings',                   struct( ...
            'xCenter',                    0,                ...
            'yCenter',                    0,                ...
            'coherenceSTD',               10,               ...
    ...
    methods
        ...
        function self = topsTreeNodeTaskReversingDotsDebug(varargin)
    ...
    methods (Access = protected)
        ...
        function prepareDrawables(self)
            ...
            ensemble.setObjectProperty('recordDotsPositions', self.settings.recordDotsPositions, self.dotsIndex);
