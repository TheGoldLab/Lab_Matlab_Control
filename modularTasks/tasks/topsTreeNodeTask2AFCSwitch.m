classdef topsTreeNodeTask2AFCSwitch < topsTreeNodeTask
   ...
   properties % (SetObservable) % uncomment if adding listeners
      ...
      settings = struct( ...
         ...
         'targetDistance',             8.0, ... % degrees visual angle
         'minimumRT',                  0.0, ...
   ...
   methods
      ...
      function startTrial(self)
         ...
         self.helpers.stimulusEnsemble.theObject.setObjectProperty( ...
            'x', -self.settings.targetDistance, 2);
         self.helpers.stimulusEnsemble.theObject.setObjectProperty( ...
            'x',  self.settings.targetDistance, 3);
      ...
      function showStimulus(self)
         ...
         if self.settings.useDrawables
            self.helpers.stimulusEnsemble.draw({trial.stim+1, []}, ...
               self, 'drawOn');
         end
      ...
      function hideStimulus(self)
         ...
         %
         if self.settings.useDrawables
            self.helpers.stimulusEnsemble.draw({[], [2 3]}, ...
               self, 'drawOff');
         end
      end
   ...
   methods (Access = protected)
      ...
      function initializeStateMachine(self)
         ...
         showfp = {@draw, self.helpers.stimulusEnsemble, {1, [2 3]}, self, 'fixationOn'};
